...
class Parser(object):
    ...
    def factor(self):
        ...
        self.list += str(self.current_token.value)
        if token.type == INTEGER:
            ...
            self.currentTree.setRootVal(token.value)
...
class Interpreter(NodeVisitor):
    ...
    def visit_BinOp(self, node):
        self.list += str(self.visit(node.left))
        self.list += str(node.op.value)  
        self.list += str(self.visit(node.right))
        self.list += '\n'
